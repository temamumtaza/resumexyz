...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Set up resumexyz',
  'settings.welcomeSubtitle':
    "Pick how you'd like to run resume generations. You can change this any time from the Settings button in the top bar.",
  ...
  'settings.privacyHint': 'What data is shared with the resumexyz team',
  'settings.privacyConsentKicker': 'Help us improve resumexyz',
  'settings.privacyConsentLead': 'resumexyz can share usage data with our team to help us improve. This includes:',
  ...
  'newproj.namePlaceholder': 'Resume name',
  ...
  'designs.subYours': 'Your resumes',
  'designs.filterAria': 'Filter projects',
  'designs.searchPlaceholder': 'Search…',
  'designs.emptyNoProjects': 'No resumes yet. Create one on the left.',
  ...
  'chat.startHint':
    'Drop or paste an existing resume, LinkedIn export, job description, or notes. Or try one of these starters:',
  ...
  'chat.composerPlaceholder':
    'Describe the resume you need — paste career notes, a job description, or @ a file…',
  'chat.composerHint':
    '⌘/Ctrl + Enter to send · paste resume notes, LinkedIn text, or a job description',
  ...
  'chat.example1Title': 'ATS resume refresh',
  'chat.example1Tag': 'General',
  'chat.example1Prompt':
    'Create an ATS-friendly resume from my work history. Ask at most 3 questions per turn, complete each HR checklist section before moving on, then export only resume.docx and resume.pdf.',
  'chat.example2Title': 'Tailor to a job',
  'chat.example2Tag': 'Targeted',
  'chat.example2Prompt':
    'Tailor my resume to this job description. Preserve truthful facts, rewrite bullets with measurable impact, align keywords for ATS, and show the final ResumeXYZ score.',
  'chat.example3Title': 'Career switch resume',
  'chat.example3Tag': 'Transition',
  'chat.example3Prompt':
    'Build a resume for a career transition. Ask for missing details, translate my prior experience into relevant achievements, and keep the output ATS-safe and recruiter-readable.',
  ...
  'workspace.designFiles': 'Resume Preview',
  ...
  'designFiles.dropDesc':
    'Resume source files, notes, and job descriptions can be attached from the chat composer.',
