...
export const id: Dict = {
  ...
  'app.brand': 'resumexyz',
  'app.brandPill': 'ATS Resume Generator',
  'app.brandSubtitle': 'Resume builder',
  'app.welcomeLoading': 'Memuat workspace...',

  'settings.welcomeKicker': 'Selamat datang',
  'settings.welcomeTitle': 'Siapkan resumexyz',
  'settings.welcomeSubtitle': 'Pilih cara menjalankan generasi resume. Ini bisa diubah kapan saja dari tombol Settings di bar atas.',
  ...
  'settings.privacyHint': 'Data yang dibagikan dengan tim resumexyz',
  'settings.privacyConsentKicker': 'Bantu kami meningkatkan resumexyz',
  'settings.privacyConsentLead': 'resumexyz dapat membagikan data penggunaan dengan tim kami untuk membantu peningkatan. Ini mencakup:',
  ...
  'entry.tabDesigns': 'Manage Resumes',
  'entry.tabTemplates': 'Resume Templates',
  ...
  'newproj.tabPrototype': 'Resume generator',
  ...
  'newproj.titlePrototype': 'Resume generator',
  ...
  'newproj.namePlaceholder': 'Nama resume',
  ...
  'designs.subYours': 'Resumemu',
  'designs.filterAria': 'Filter proyek',
  'designs.searchPlaceholder': 'Cari...',
  'designs.emptyNoProjects': 'Belum ada resume. Buat satu dari panel kiri.',
  ...
  'chat.startHint': 'Tempel resume lama, ekspor LinkedIn, deskripsi pekerjaan, atau catatan karier. Atau coba salah satu starter ini:',
  ...
  'chat.composerPlaceholder':
    'Jelaskan resume yang kamu butuhkan — tempel catatan karier, deskripsi pekerjaan, atau @ file…',
  'chat.composerHint':
    '⌘/Ctrl + Enter untuk kirim · tempel catatan karier, LinkedIn, atau deskripsi pekerjaan',
  ...
  'chat.example1Title': 'Refresh resume ATS',
  'chat.example1Tag': 'Umum',
  'chat.example1Prompt': 'Buat resume yang ATS-friendly dari riwayat kerja saya. Tanyakan maksimal 3 pertanyaan per giliran, selesaikan tiap bagian checklist HR sebelum lanjut, lalu export hanya resume.docx dan resume.pdf.',
  'chat.example2Title': 'Sesuaikan ke lowongan',
  'chat.example2Tag': 'Target',
  'chat.example2Prompt':
    'Sesuaikan resume saya ke deskripsi pekerjaan ini. Pertahankan fakta yang benar, tulis ulang bullet dengan dampak terukur, selaraskan keyword ATS, dan tampilkan skor akhir ResumeXYZ.',
  'chat.example3Title': 'Resume pindah karier',
  'chat.example3Tag': 'Transisi',
  'chat.example3Prompt': 'Buat resume untuk transisi karier. Tanyakan detail yang kurang, terjemahkan pengalaman sebelumnya menjadi pencapaian yang relevan, dan jaga output tetap aman untuk ATS serta mudah dipindai recruiter.',
  ...
  'workspace.designFiles': 'Preview Resume',
  ...
  'designFiles.dropDesc': 'File resume, catatan, dan deskripsi pekerjaan bisa dilampirkan dari chat.',
